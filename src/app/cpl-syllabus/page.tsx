...
// Map CPL subject name → PDF path
const subjectPdfs: Record<string, string> = {
  "Air Navigation": "/pdfs/cpl-subject-wise-syllabus/cpl-syllabus-air-navigation.pdf",
  "Aviation Meteorology": "/pdfs/cpl-subject-wise-syllabus/cpl-syllabus-aviation-meteorology.pdf",
  "Air Regulation": "/pdfs/cpl-subject-wise-syllabus/cpl-syllabus-air-regulation.pdf",
  "Aircraft and Engines": "/pdfs/cpl-subject-wise-syllabus/cpl-syllabus-technical-general.pdf",
  "Radio Navigation and Instruments": "/pdfs/cpl-subject-wise-syllabus/cpl-syllabus-radio-navigation-instruments.pdf",
};

export default async function CplSyllabusPage() {
  // Fetch COMMON + CPL subjects only
  ...
  return (
    <main className="max-w-4xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6">DGCA CPL Syllabus 2025</h1>
      <p className="mb-6 text-gray-700">
        Explore each subject below or{" "}
        <Link
          href="/pdfs/cpl-syllabus.pdf"
          target="_blank"
